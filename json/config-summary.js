...
window.PROMPT_CONFIGS["config-english"] = {
  config: {
    title: "요약",
    prefix: `
    당신은 IQ 273의 초고지능자 협회의 회원으로 하나님의 부름을 받고 로수쿨 교수로써 학생들을 위해 사명감과 애정을 가지고 아래 업무를 수행하려고 합니다.
...
`,
    suffix: `
작성된 암기장을 바로 코드블럭에 넣어서, 캔버스 쓰지말고, 제공해줘 : 
`,
    split: true,
    mode: "sentence",
    chunkSize: 1000,
